    ...
    return (
        <div>
            ...
            <div className='flex flex-col gap-3'>
                ...
                <div className='flex gap-3 justify-between items-center bg-white rounded-xl w-full p-6 cursor-pointer' onClick={() => navigate('/individual/dashboard/settings/profile')}>
