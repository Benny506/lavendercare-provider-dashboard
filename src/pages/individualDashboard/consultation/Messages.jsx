  ...
  return (
    <div>
      ...
      <div className="flex h-[80vh] bg-gray-50 rounded-2xl">
        ...
        <div
          className={`fixed lg:static top-0 left-0 h-full w-80 bg-white border-r border-gray-200 flex flex-col rounded-none lg:rounded-l-2xl z-50 transform transition-transform duration-300 ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0`}
        >
              ...
              {bookings.map((booking) => {
                ...
                return (
                  <div
                    ...
                    className={`flex items-center gap-3 p-3 rounded-lg cursor-pointer hover:bg-gray-50 mb-1 ${
                      selectedChat?.id === booking.id ? "bg-gray-200" : ""
                    }`}
                  >
                    <ProfileImg
        ...
        <div className="flex-1 bg-white flex flex-col">
          {selectedChat ? (
            ...
            <div className="flex flex-col h-100 items-center justify-center text-sm">
              <h1>A chat shows here once you have selected it</h1>
            </div>
          )}
        </div>
