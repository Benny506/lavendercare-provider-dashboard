    ...
    return (
        <div className="md:p-6 min-h-screen">
            ...
            <div className="flex flex-col lg:flex-row">
                ...
                {/* Right Panel */}
                <div className="flex-1 w-full bg-white rounded-b-lg lg:rounded-r-lg lg:rounded-bl-none">
                    {/* Assigned Provider */}
                    <div className="p-6">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                <Avatar className="w-12 h-12">
                                    ...
                                    <AvatarFallback className="bg-gray-200 text-gray-700">ER</AvatarFallback>
                                </Avatar>
                                <div>
