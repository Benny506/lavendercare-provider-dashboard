        ...
        },        
        {
            ...
            render: (row) => (
                <button 
                    ...
                    className="cursor-pointer px-4 py-1 text-sm bg-purple-500 text-white rounded-4xl"
                >
                    View
                </button>
            ),
        ...
        <div className="py-6">
            <div className="flex flex-wrap items-center gap-5 mb-6 justify-between">
                ...
                <button 
                    ...
                    className="flex items-center gap-2 py-2 px-3 rounded-2xl cursor-pointer bg-purple-500 text-grey-50"
                >
                    ...
                    <span className="font-medium text-white text-md">Create ticket</span>
                </button>
            </div>
