        ...
        <div>
            ...
            <div>
                ...
                <div className="w-full bg-white rounded-2xl p-3">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 md:gap-0 p-4">
                    ...
                    <form className="w-full md:w-xl flex flex-col gap-4 p-4">
                    {/* Hospital Name */}
                    <div>
                        <label className="mb-1 text-sm font-medium">Hospital Name</label>
                        <input type="text" placeholder="What is the doctor Full Name" className="border border-[#B1B1B0] focus:outline-none rounded-lg px-3 py-2 w-full text-base" />
                    </div>
                    {/* Email Address */}
                    <div>
                        <div className="mb-1 text-sm font-medium">Official Email</div>
                        <input type="email" placeholder="What is the doctor Email Address" className="border border-[#B1B1B0] focus:outline-none rounded-lg px-3 py-2 w-full text-base " />
                    </div>
                    {/* Official Phone Number */}
                    <div>
                        <div className="mb-1 text-sm font-medium">Phone Number</div>
                        <div className="flex">
                            <select className="border border-[#B1B1B0] focus:outline-none rounded-l-lg px-1 py-2 text-base bg-white" defaultValue="+234">
                                <option value="+234">+234</option>
                                <option value="+234">+234</option>
                                <option value="+234">+234</option>
                            </select>
                            <input type="text"  placeholder="81234232323" className="border-t border-b border-r border-[#B1B1B0] focus:outline-none rounded-r-lg px-3 py-2 w-full text-base" />
                        </div>
                    </div>
                    ...
                    <div className='flex items-center justify-between relative max-w-1/3'>
                        <Button type="button" className="bg-[#D2C3EF] text-white rounded-full py-5 md:py-6 font-semibold md:text-lg mt-4 w-full flex items-center justify-center cursor-pointer">
                            Save Changes
                        </Button>
                    </div>
                </form>
