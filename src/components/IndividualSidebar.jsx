...
const navItems = [
    ...
    {
        label: 'Set Availability & Fee', icon: (
    ...
    },
    {
        label: 'Consultations', icon: (
            <Icon icon="ant-design:message-outlined" width="24" height="24" style={{ color: "#000000" }} />
        )
    },
    {
        label: 'Bookings', icon: (
            <Icon icon="ph:bookmark" width="24" height="24" style={{ color: "#000000" }} />
        )
    },
    {
        label: 'Caseload', icon: (
            <Icon icon="octicon:people-24" width="24" height="24" style={{ color: "#000000" }} />
        )
    },
    {
        label: 'Screenings', icon: (
            <Icon icon="material-symbols:note-outline" width="24" height="24" style={{ color: "#000000" }} />
        )
    },
];
